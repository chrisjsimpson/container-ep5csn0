...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-ep5csn0.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-ep5csn0.containers.anotherwebservice.com/
...
```
git clone git@github.com:chrisjsimpson/container-ep5csn0.git
cd container-ep5csn0
```
...
```
docker attach container-ep5csn0
```
